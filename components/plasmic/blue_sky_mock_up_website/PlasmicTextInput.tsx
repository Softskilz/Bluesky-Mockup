...
import sty from "./PlasmicTextInput.module.css"; // plasmic-import: qAeYDifi-P0K/css

import SearchSvgIcon from "./icons/PlasmicIcon__SearchSvg"; // plasmic-import: ZIG-cR0h3PJC/icon
    ...
    >
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <SearchSvgIcon
              className={classNames(projectcss.all, sty.svg__kQbqE)}
              role={"img"}
            />
          ),
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <CheckSvgIcon
              className={classNames(projectcss.all, sty.svg__n4EMu)}
              role={"img"}
            />
          ),
